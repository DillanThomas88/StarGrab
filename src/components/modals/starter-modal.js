  ...
  return (
    <>
      <div className='fixed animate-fadeIn w-full px-4 h-full z-50 flex justify-center items-center'>
        <div className={`flex flex-col question-modal ${data} relative justify-start items-start w-full rounded-md border border-neutral-600 h-fit pb-5 bg-neutral-900 shadow-md shadow-black text-xs px-4`}>
          ...
          <div className='mt-2'>
            <div className='font-thin'>
              After selecting your tiles of the same color, any tile values, with a<span className='ml-1 font-normal'>star</span> will be added to your score.
            </div>
          ...
          <p className=' mt-1'><span className='font-thin'>Two yellow tiles can be selected (<span className='font-normal text-yellow-300'> 3 <span className='font-thin text-white'>and</span> 12 </span>) to complete the sum of <span className='px-1 font-semibold h-4 w-4 bg-white rounded-sm text-neutral-900 mx-1'>15</span> </span> </p>
          <p className='mt-2 font-thin'>After selecting both tiles, tap the <span className='px-1 font-semibold h-4 w-4 bg-white rounded-sm text-neutral-900'>15</span> and you will gain 12 points from the tile that had a star value of <span className='text-yellow-300 font-semibold'>12</span>.</p>
